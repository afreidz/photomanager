...
export const FeaturedGalleryManagement = observer(function FeaturedGalleryManagement() {
  ...
  const featuredGalleries = Array.isArray(galleryStore.galleries) 
    ? galleryStore.galleries.filter(gallery => gallery.isFeatured)
    : [];
  ...
  // Loading state
  if (galleryStore.isLoading && featuredGalleries.length === 0) {
    return (
      <div className="p-8">
      ...
      <div className="w-full">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              {featuredGalleries.length} featured galleries
            </p>
          </div>
        ...
        {featuredGalleries.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-foreground mb-2">No featured galleries yet</h3>
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              You haven't marked any galleries as featured yet. Featured galleries will be highlighted on your public site.
            </p>
